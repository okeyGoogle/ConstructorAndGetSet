...
/*
 * Демонстрироую работу конструктора класса
и Геттеры и Сеттеры 
 */
...
//Сдесь мы создаём геттеры и сеттеры класса Human 
//необходиммые для установки и вызова свойств объекта этого класса
...
//======================================================
    ...
    //Ниже прожемонстрирован результат работы конструктора, геттера, сеттера 
    //при созданиее объкта класса Human
     void say() {
